...
import useForm, { UseFormReturn } from "../hook/useForm";

const FORM_CONTEXT = createContext<UseFormReturn | null>(null)
...
export function FORM_PROVIDER({ schema, children }: { schema: any[]; children: React.ReactNode }) {
...
export function useFormContext() {
    const context = useContext(FORM_CONTEXT);
    if (!context) {
        throw new Error("useFormContext must be used within a FORM_PROVIDER");
    }
    return context;
}
